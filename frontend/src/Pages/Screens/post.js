...
function Post(props) {
    ...
    axios.get(`http://127.0.0.1:8000/api/user/${props.post.User}`).then(
        response=>{
  ...
  return (
    <div className='mx-20 border-b-2' key={props.post.id}>
            ...
            <div className=''>
              ...
              <div className='flex items-center'>
                ...
                <span className='ml-2 text-gray-400'>Oct 4</span>
              </div>
        ...
        <div className='flex items-center justify-around mb-3 mt-3'>
          ...
          <div>
          <button><ChatBubbleOutlineOutlinedIcon/>
          3
          </button>
          </div>
